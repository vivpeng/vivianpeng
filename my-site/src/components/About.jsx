...
function About() {
    ...
    return (
        ...
        transition-all duration-1000 ease-out w-[80vw] 
    ...
    `}
        ...
        transition-all duration-1000 ease-out delay-300 w-[80vw]
        ${mountainsVisible ? "translate-x-0 opacity-100" : "-translate-x-24 opacity-0"}
    `}
                />
    ...
    `}
            ...
            `}>
                ...
                {/* TITLE */}
                <h2 className="text-4xl font-bold mb-8 text-center -mt-20">
                    about
                </h2>
                ...
                <div className="flex flex-col md:flex-row items-start justify-center gap-8">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        {/* PROFILE PHOTO */}
                        <div className="w-[120px] sm:w-[140px] md:w-[180px] lg:w-[220px] aspect-[3/4] rounded-2xl overflow-hidden bg-gray-300">
                            <img
                    ...
                    <div className="flex-1 text-left">
                        ...
                        <p className="leading-relaxed text-sm text-gray-800 mb-6">
                            ...
                            I love exploring and learning new things, whether that’s through building software, picking up new activities, or meeting various people along the way.
                            <br /><br />
                            ...
                            <br /><br />
                            When I'm not doing that, you’ll usually find me swimming, listening to a podcast, or watching a horror game playthrough.
                            <br /><br />
